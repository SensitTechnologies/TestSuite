namespace Sensit.App.G3
{
	partial class FormG3
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBoxMassFlow.Controls.Add(this.tableLayoutPanel2);
			...
			this.groupBoxMassFlow.TabIndex = 8;
			...
			this.tableLayoutPanel2.Controls.Add(this.textBoxFilename, 0, 0);
			...
			this.groupBoxBaudRate.TabIndex = 10;
			...
			this.groupBoxInterval.TabIndex = 11;
			...
			// groupBoxCommand
			// 
			this.groupBoxCommand.AutoSize = true;
			...
			this.groupBoxCommand.Location = new System.Drawing.Point(0, 163);
			this.groupBoxCommand.Name = "groupBoxCommand";
			this.groupBoxCommand.Size = new System.Drawing.Size(435, 58);
			this.groupBoxCommand.TabIndex = 13;
			this.groupBoxCommand.TabStop = false;
			this.groupBoxCommand.Text = "First Command";
			// 
			// textBoxCommand
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.buttonStop, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.buttonStart, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.buttonRead, 1, 0);
			this.tableLayoutPanel1.Location = new System.Drawing.Point(97, 3);
			...
			this.buttonRead.Location = new System.Drawing.Point(163, 3);
