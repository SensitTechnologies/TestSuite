namespace Sensit.App.GPS
{
	partial class FormGPS
	{
		...
		private void InitializeComponent()
		{
			...
			this.tableLayoutPogo.Controls.Add(this.buttonStartSingle, 6, 4);
			this.tableLayoutPogo.Controls.Add(this.buttonStop, 6, 2);
			this.tableLayoutPogo.Controls.Add(this.buttonStartPanel, 6, 0);
